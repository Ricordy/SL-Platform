...
const NoInvestments: React.FC<NoInvestmentProps> = ({
  ...
  return (
    <div className="ml-[58px] grid grid-flow-row auto-rows-auto grid-cols-3 justify-center gap-4 pb-[132px] ">
      ...
      <div className="flex items-center justify-center rounded-md bg-contactBackground">
        <svg
          version="1.2"
      ...
      <div className="flex h-[394px] w-[416px] items-center justify-center rounded-md bg-contactBackground">
        <svg
          version="1.2"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 64 64"
